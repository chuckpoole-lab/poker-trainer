...
FACING_OPEN_RAW = {
    ...
    'utg_bb_25': {'jam': 'QQ+, AKs, AKo', 'call': '22-JJ, A2s+, ATo+, K9s+, KTo+, Q9s+, J9s+, T9s, 98s, 87s'},
    ...
    'co_sb_25': {'jam': 'TT+, AQs+, AKo, A5s, A4s', 'call': '22-99, A2s-A9s, ATo+, KTs+, KJo+, QTs+, JTs, T9s'},
    'co_sb_30': {'jam': 'TT+, AQs+, AKo', 'call': '22-99, A2s+, ATo+, KTs+, KJo+, QTs+, JTs, T9s, 98s'},
