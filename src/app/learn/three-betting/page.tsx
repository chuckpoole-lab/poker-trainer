...
import { THREE_BETTING_MODULE } from '@/lib/data/training-modules-prototype';

export default function ThreeBettingLessonPage() {
  const router = useRouter();
  const mod = THREE_BETTING_MODULE;
    ...
    <div style={{ padding: '20px 16px 100px', maxWidth: 480, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', margin: '0 0 12px' }}>
          Ready to practice? Drill spots where you face a 3-bet.
        </p>
        <button
          className="btn-primary"
          onClick={() => router.push('/drills/session?module=mod_facing_3bets&count=15')}
          style={{ width: '100%' }}
        >
          Start Facing 3-Bets Drill
        </button>
